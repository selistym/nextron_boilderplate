...
import { ADD_CORE_MUTATION } from '@app/renderer/graphql/core/addCore.mutation';
import { GET_WORKSPACE_OPTIONS_AND_CORES_QUERY } from '@app/renderer/graphql/workspace/getWorkspaceOptionsAndCores.query';

import { AddCoreInput, WorkspaceIdInput } from '@app/renderer/types/graphql-global-types';
