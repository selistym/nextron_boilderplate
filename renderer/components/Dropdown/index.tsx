...
import { Container, IconStyle, OptionContainer, Title } from './styled';
      ...
      <Container tabIndex={0} onKeyDown={handleKeyDown} className={className}>
        {options &&
          options.map((option, index) => (
            ...
            >
              {option.icon && (
                <Icon css={IconStyle} icon={glyphs[option.icon]} size={{ width: 16, height: 16 }} />
              )}
              <Title>
