...
import { GET_WORKSPACE_CORES_QUERY } from '@app/renderer/graphql/workspace/getWorkspaceCores.query';
import { GetWorkspaceCoresQuery as IWorkspace } from '@app/renderer/graphql/workspace/types/GetWorkspaceCoresQuery';

const HARDCODED_WORKSPACE: string = 'workspace_id_647b9378-301e-41d2-81e0-fbfa9da2813e';
// TODO: use redux activeWorkspaceId
